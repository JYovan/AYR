    ...
    <div class="card-body">
        <div class="row">
            <div class="col-6 col-sm-6 float-left">
                <legend class="float-left">Cubo de Información del Cliente</legend>
            </div>
...
<!--SCRIPT-->
<script>
    var master_url = base_url + 'index.php/CuboCliente/';
    ...
    function getRecords() {
        ...
        $.when
                (
                        $.getJSON(master_url + 'getCuboInformacionClientes').done(function (data, x, jq) {
                    ...
                    if (pivotConfig === '') {
                        ...
                        var saveConfig = JSON.parse(getCookie("pivotConfig"));
