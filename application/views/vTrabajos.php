                    ...
                    <table  id="tblConceptosXTrabajo" class="table table-striped table-hover hide" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th class="col-md-2" align="center">Unidad</th>
            ...
            $.each(EditarCroquisPorConcepto[0].files, function(k, file) {
                ...
                reader.onload = function(e) {
                    ...
                    $.ajax({
                        ...
                        onReloadCroquisXConcepto(mdlTrabajoEditarCroquisPorConcepto.find("#IdTrabajoDetalle").val());
            ...
            $.each(EditarFotosPorConcepto[0].files, function(k, file) {
                ...
                reader.onload = function(e) {
                    ...
                    $.ajax({
                        ...
                        onReloadFotosXConcepto(mdlTrabajoEditarFotosPorConcepto.find("#IdTrabajoDetalle").val());
            ...
            mdlTrabajoNuevoConcepto.find('#tblConceptosXPreciarioID tbody').on('click', 'tr', function() {
                ...
                $.ajax({
                    ...
                    if (has_id) {
                        ...
                        row += '</td>';
                        row += '<td>';
                        row += '<span class="fa fa-gears fa-3x customButtonDetalleGenerador mx-auto" onclick="onGeneradorXConcepto(this)"></span>';
                        row += '</td>';
...
//        mdlTrabajoNuevoAnexosPorConcepto.modal('show');
        ...
        $.ajax({url: master_url + 'getTrabajoAnexosDetalleByID',
            ...
            $.each(data, function(k, v) {
                ...
                if (url_file !== null && url_file !== undefined && url_file !== '') {
                    ...
                    if (ext === "gif" || ext === "jpg" || ext === "png") {
                        mdlTrabajoEditarAnexosPorConcepto.find("div#Anexos").append('<a href="' + url_file + '" target="_blank"><img src="' + base_url + v.Url + '" class="img-responsive"></a><div class="col-md-12" align="center"><button type="button" class="btn btn-raised btn-danger" onclick="onEliminarAnexoXConcepto(' + v.ID + ',' + v.IdTrabajoDetalle + ')"><span class="fa fa-times"></span><br>ELIMINAR</button></div>');
                    }
                    if (ext === "PDF" || ext === "Pdf" || ext === "pdf") {
                        mdlTrabajoEditarAnexosPorConcepto.find("div#Anexos").append('<hr> <embed src="' + url_file + '" type="application/pdf" width="100%" height="800px"' +
                                ' pluginspage="http://www.adobe.com/products/acrobat/readstep2.html"><br><div class="col-md-12" align="center"><button type="button" class="btn btn-raised btn-danger" onclick="onEliminarAnexoXConcepto(' + v.ID + ',' + v.IdTrabajoDetalle + ')"><span class="fa fa-times"></span><br>ELIMINAR</button></div>');
                    }
                    if (ext !== "gif" && ext !== "jpg" && ext !== "png" && ext !== "PDF" && ext !== "Pdf" && ext !== "pdf") {
                        mdlTrabajoEditarAnexosPorConcepto.find("div#Anexos").append('<h1>NO EXISTE ARCHIVO ADJUNTO</h1>');
                    }
                } else {
    ...
    function onReloadCroquisXConcepto(IDX) {
        HoldOn.open({
            theme: "sk-bounce",
            message: "CARGANDO CROQUIS..."
        });
    ...
    function onReloadAnexosXConcepto(IDX) {
        HoldOn.open({
            theme: "sk-bounce",
            message: "CARGANDO ANEXOS..."
        });
        $.ajax({url: master_url + 'getTrabajoAnexosDetalleByID',
            ...
            $.each(data, function(k, v) {
                ...
                if (url_file !== null && url_file !== undefined && url_file !== '') {
                    ...
                    if (ext === "gif" || ext === "jpg" || ext === "png") {
                        mdlTrabajoEditarAnexosPorConcepto.find("#Anexos").append('<a href="' + url_file + '" target="_blank"><img src="' + base_url + v.Url + '" class="img-responsive"></a><div class="col-md-12" align="center"><button type="button" class="btn btn-raised btn-danger" onclick="onEliminarAnexoXConcepto(' + v.ID + ',' + v.IdTrabajoDetalle + ')"><span class="fa fa-times"></span><br>ELIMINAR</button></div>');
                    }
                    if (ext === "PDF" || ext === "Pdf" || ext === "pdf") {
                        mdlTrabajoEditarAnexosPorConcepto.find("#Anexos").append('<hr> <embed src="' + url_file + '" type="application/pdf" width="100%" height="800px"' +
                                ' pluginspage="http://www.adobe.com/products/acrobat/readstep2.html"><br><div class="col-md-12" align="center"><button type="button" class="btn btn-raised btn-danger" onclick="onEliminarAnexoXConcepto(' + v.ID + ',' + v.IdTrabajoDetalle + ')"><span class="fa fa-times"></span><br>ELIMINAR</button></div>');
                    }
                    if (ext !== "gif" && ext !== "jpg" && ext !== "png" && ext !== "PDF" && ext !== "Pdf" && ext !== "pdf") {
                        mdlTrabajoEditarAnexosPorConcepto.find("#Anexos").append('<h1>NO EXISTE ARCHIVO ADJUNTO</h1>');
                    }
                } else {
                    mdlTrabajoEditarAnexosPorConcepto.find("#Anexos").html('<h3>NO EXISTEN ANEXOS ADJUNTOS</h3>');
                }
            });
    ...
    function onEliminarCroquisXID(IDX, IDTD) {
        HoldOn.open({
            theme: "sk-bounce",
    ...
    function onEliminarAnexoXConcepto(IDX, IDTD) {
        HoldOn.open({
            theme: "sk-bounce",
            message: "ELIMINANDO ANEXO..."
        });
